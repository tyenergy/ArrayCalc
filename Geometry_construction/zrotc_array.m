function zrotc_array(ang,elstart,elfinish)
% Rotate and copy array geometry about z-axis, rotation is relative
% to the current orientation, new elements are added onto the end
% of array_config.
%
% Usage : zrotc_array(ang,elstart,elfinish)
%
...
fprintf('Rotate-copy elements %i to %i around Z-axis by %3.2f Deg\n',...
